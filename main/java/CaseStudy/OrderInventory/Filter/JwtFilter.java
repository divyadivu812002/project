package CaseStudy.OrderInventory.Filter;
...
public class JwtFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
	    ...
	    if ((request.getRequestURI().startsWith("/api/auth") && request.getMethod().equals("POST")) ||
	        (request.getRequestURI().equals("/api/inventory/manager/register") && request.getMethod().equals("POST")) || 
	        (request.getRequestURI().equals("/api/admin/register") && request.getMethod().equals("POST")) || 
	        (request.getRequestURI().equals("/api/store/manager/register") && request.getMethod().equals("POST"))){
